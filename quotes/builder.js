...
(function () {
  ...
  function dashboardHtml() {
    return `
      <main class="qb-form-col" style="max-width:1200px">
                ...
                ${state.quotes.map((q) => `
                  <tr>
                    ...
                    <td style="text-align:right">
                      ...
                      <button class="qb-link-btn" data-share="${escapeAttr(q.public_token)}">Share link</button>
                    </td>
                  </tr>
                `).join('')}
              </tbody>
        ...
        <main class="qb-form-col">
          ...
          <section class="qb-section">
            <div class="qb-section-head">
              ...
              <span class="qb-section-hint">Optional</span>
            </div>
            <div class="qb-fields">
              ...
              <div class="qb-field qb-full">
                <div class="qb-label-row"><label class="qb-label">Internal notes (private)</label></div>
                <textarea class="qb-textarea" data-field="notes" placeholder="Notes for your team — never shown to the borrower.">${escapeHtml(e.form.notes)}</textarea>
              </div>
            </div>
          </section>
